...
public class EntityList
{
	...
	public static Entity createEntityFromNBT(NBTTagCompound p_75615_0_, World p_75615_1_)
	{
		...
		if (entity != null) {
			...
			{
				FMLLog.log(Level.ERROR, e, "An Entity %s(%s) has thrown an exception during loading, its state cannot be restored. Report this to the mod author", new Object[] { p_75615_0_.getString("id"), oclass.getName() });
