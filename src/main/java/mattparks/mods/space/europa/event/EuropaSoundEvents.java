//package mattparks.mods.space.europa.event;
//
...
//
//public class EuropaSoundEvents
//{
//	@SideOnly(Side.CLIENT)
//	@SubscribeEvent
//	public void onSoundLoad(SoundLoadEvent event)
//	{
//		ClientProxySpace.newMusic.add(this.func_110654_c(event.manager.soundPoolMusic, "galacticrafteuropa:music/Europa_Snowstorm.ogg"));
//	}
//
//	@SideOnly(Side.CLIENT)
