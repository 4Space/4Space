...
public class SkyProviderEuropa extends IRenderHandler
{
    ...
    private final boolean renderJupiter;
    ...
    public SkyProviderEuropa(ResourceLocation planet, boolean renderJupiter, boolean renderSun)
    {
        this.planetToRender = planet;
        this.renderJupiter = renderJupiter;
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        {
            var12 = 28.0F;
            this.minecraft.renderEngine.bindTexture(SkyProviderEuropa.sunTexture);
        ...
        if (this.renderJupiter)
        {
            var12 = 40.0F;
            this.minecraft.renderEngine.bindTexture(SkyProviderEuropa.jupiterTexture);
