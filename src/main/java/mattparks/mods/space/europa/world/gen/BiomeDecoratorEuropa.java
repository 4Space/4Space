...
//	public int europaWaterLakesPerChunk;
	...
	{
		this.dirtyIce = new WorldGenMinableMeta(EuropaBlocks.europaIce, 8, 1, true, IoBlocks.ioBasicBlock, 2);
		this.denceIce = new WorldGenMinableMeta(EuropaBlocks.europaIce, 8, 2, true, IoBlocks.ioBasicBlock, 2);
