package mattparks.mods.space.core.render.tile;
...
{
	private static final ResourceLocation treasureChestTexture = new ResourceLocation("galacticraftvenus:textures/model/venusTreasureChest.png");
	private static final ResourceLocation treasureLargeChestTexture = new ResourceLocation("galacticraftvenus:textures/model/venusLargeTreasureChest.png");
	...
	public void renderGCTileEntityTreasureChestAt(TileEntityVenusTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		else
		{
			...
			{
				((BlockT4VenusTreasureChest) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
				var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
			}
		...
		if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null)
		{
			...
			if (par1GCTileEntityTreasureChest.adjacentChestXPos == null && par1GCTileEntityTreasureChest.adjacentChestZPos == null)
			{
				...
				this.bindTexture(TileEntityVenusTreasureChestRenderer.treasureChestTexture);
			}
			else
			{
				var14b = this.largeChestModel;
				this.bindTexture(TileEntityVenusTreasureChestRenderer.treasureLargeChestTexture);
			}
