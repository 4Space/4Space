...
{
	private static final ResourceLocation treasureChestTexture = new ResourceLocation("galacticraftmercury:textures/model/mercuryTreasureChest.png");
	private static final ResourceLocation treasureLargeChestTexture = new ResourceLocation("galacticraftmercury:textures/model/mercuryLargeTreasureChest.png");
	...
	public void renderGCTileEntityTreasureChestAt(TileEntityMercuryTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		else
		{
			...
			{
				((BlockT4MercuryTreasureChest) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
				var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
			}
		...
		if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null)
		{
			...
			else
			{
				...
				this.bindTexture(TileEntityMercuryTreasureChestRenderer.treasureLargeChestTexture);
			}
