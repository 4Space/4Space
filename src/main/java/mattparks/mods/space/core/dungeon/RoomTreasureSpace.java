package mattparks.mods.space.core.dungeon;
...
public class RoomTreasureSpace extends DungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public RoomTreasureSpace(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new RoomTreasureSpace(dungeon, x, y, z, dir);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		if (!this.chests.isEmpty())
		{
			...
			for (final ChunkCoordinates coords : this.chests)
			{
				...
				this.worldObj.setTileEntity(coords.posX, coords.posY, coords.posZ, new TileEntityTreasureChest());
