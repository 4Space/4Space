...
public class RoomEmptySpace extends DungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;

	public RoomEmptySpace(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new RoomEmptySpace(dungeon, x, y, z, dir);
	}
