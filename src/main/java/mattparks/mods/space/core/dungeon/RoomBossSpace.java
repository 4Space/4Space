...
public class RoomBossSpace extends DungeonRoom
{
	public int sizeX;
	public int sizeY;
	public int sizeZ;
	...
	public RoomBossSpace(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new RoomBossSpace(dungeon, x, y, z, dir);
	}
