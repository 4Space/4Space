...
public class RoomChestsSpace extends DungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public RoomChestsSpace(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new RoomChestsSpace(dungeon, x, y, z, dir);
	}
