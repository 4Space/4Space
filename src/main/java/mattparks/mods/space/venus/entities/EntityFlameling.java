...
public class EntityFlameling extends EntityMob implements IEntityBreathable
{
	public EntityFlameling(World par1World)
	{
		super(par1World);
	...
	protected void attackEntity(Entity par1Entity, float par2)
	{
		...
		((EntityLivingBase)par1Entity).setFire(5);
	}
