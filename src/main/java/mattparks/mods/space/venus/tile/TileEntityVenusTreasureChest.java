package mattparks.mods.space.venus.tile;

import java.util.Iterator;
import java.util.List;

import mattparks.mods.space.venus.blocks.BlockT4VenusTreasureChest;
...
public class TileEntityVenusTreasureChest extends TileEntityAdvanced implements IInventory, IKeyable, IPacketReceiver
{
	 ...
	 */
	public TileEntityVenusTreasureChest adjacentChestZNeg;

	/**
	 * Contains the chest tile located adjacent to this one (if any)
	 */
	public TileEntityVenusTreasureChest adjacentChestXPos;

	/**
	 * Contains the chest tile located adjacent to this one (if any)
	 */
	public TileEntityVenusTreasureChest adjacentChestXNeg;

	/**
	 * Contains the chest tile located adjacent to this one (if any)
	 */
	public TileEntityVenusTreasureChest adjacentChestZPos;
	...
	public TileEntityVenusTreasureChest(int tier)
	{
		this.tier = tier;
	}
	...
	private void func_90009_a(TileEntityVenusTreasureChest par1TileEntityChest, int par2)
	{
	 ...
	 public void checkForAdjacentChests()
	{
		 if (!this.adjacentChestChecked)
		 {
			 ...
			 {
				 this.adjacentChestXNeg = (TileEntityVenusTreasureChest) this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
			 }

			 if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
			 {
				 this.adjacentChestXPos = (TileEntityVenusTreasureChest) this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
			 }

			 if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
			 {
				 this.adjacentChestZNeg = (TileEntityVenusTreasureChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
			 }

			 if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
			 {
				 this.adjacentChestZPos = (TileEntityVenusTreasureChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
			 }
	 ...
	 private boolean func_94044_a(int par1, int par2, int par3)
	 {
		 ...
		 return block != null && block instanceof BlockT4VenusTreasureChest;
	 }
	 ...
	 {
		 if (this.getBlockType() != null && this.getBlockType() instanceof BlockT4VenusTreasureChest)
		 {
			 --this.numUsingPlayers;
			 this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numUsingPlayers);
			 this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
