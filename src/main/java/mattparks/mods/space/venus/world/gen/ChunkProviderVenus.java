...
import mattparks.mods.space.venus.world.gen.dungeon.RoomSpawnerVenus;
import mattparks.mods.space.venus.world.gen.dungeon.RoomTreasureVenus;
import mattparks.mods.space.venus.world.gen.pit.MapGenBlazeNest;
import mattparks.mods.space.venus.world.gen.village.MapGenVillageVenus;
...
public class ChunkProviderVenus extends ChunkProviderGenerate {
	...
	private MapGenDungeon dungeonGenerator = new MapGenDungeon(VenusBlocks.venusBasicBlock, 12, 8, 16, 6);
