...
import mattparks.mods.space.venus.worldgen.pit.MapGenBlazeNest;
import mattparks.mods.space.venus.worldgen.village.MapGenVillageVenus;
...
public class ChunkProviderVenus extends ChunkProviderGenerate
{
	...
	private MapGenDungeon dungeonGenerator = new MapGenDungeon(VenusBlocks.venusBasicBlock, 13, 8, 16, 6);
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		if (!ConfigManagerSpace.disableVenusVillageGen)
		{
