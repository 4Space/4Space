...
public class SkyProviderIo extends IRenderHandler
{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10, -4.5D, f10, 0, 1);
		tessellator1.addVertexWithUV(f10, -4.5D, f10, 1, 1);
		tessellator1.addVertexWithUV(f10, -4.5D, -f10, 1, 0);
		tessellator1.addVertexWithUV(-f10, -4.5D, -f10, 0, 0);
		tessellator1.draw();
