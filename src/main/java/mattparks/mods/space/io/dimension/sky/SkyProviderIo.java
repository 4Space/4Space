package mattparks.mods.space.io.dimension.sky;
...
public class SkyProviderIo extends IRenderHandler
{
	...
	private static final ResourceLocation sunTexture = new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/sun.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		final float f18 = world.getStarBrightness(partialTicks);
		...
		// Render sun aura
		f10 = 20.0F;
		tessellator1.addVertex(-f10, 500.0D, -f10);
		tessellator1.addVertex(0, 500.0D, (double)-f10 * 1.5F);
		tessellator1.addVertex(f10, 500.0D, -f10);
		tessellator1.addVertex((double)f10 * 1.5F, 500.0D, 0);
		tessellator1.addVertex(f10, 500.0D, f10);
		tessellator1.addVertex(0, 500.0D, (double)f10 * 1.5F);
		tessellator1.addVertex(-f10, 500.0D, f10);
		tessellator1.addVertex((double)-f10 * 1.5F, 500.0D, 0);
		...
		tessellator1.addVertexWithUV(-f10, 500.0D, -f10, 0.0D, 0.0D);
		tessellator1.addVertexWithUV(f10, 500.0D, -f10, 1.0D, 0.0D);
		tessellator1.addVertexWithUV(f10, 500.0D, f10, 1.0D, 1.0D);
		tessellator1.addVertexWithUV(-f10, 500.0D, f10, 0.0D, 1.0D);
		tessellator1.draw();
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderIo.jupiterTexture);
		world.getMoonPhase();
