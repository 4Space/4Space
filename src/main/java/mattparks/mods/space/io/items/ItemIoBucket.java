...
public class ItemIoBucket extends Item {
	...
	private static final String[] bucketTypes = new String[] { "titaniumBucket", "ioLavaBucket", "liquidRedSulfurBucket", "liquidYellowSulfurBucket", "liquidOrangeSulfurBucket" };
