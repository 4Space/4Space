...
import mattparks.mods.space.io.world.gen.dungeon.RoomBossIo;
import mattparks.mods.space.io.world.gen.dungeon.RoomChestsIo;
import mattparks.mods.space.io.world.gen.dungeon.RoomEmptyIo;
import mattparks.mods.space.io.world.gen.dungeon.RoomSpawnerIo;
import mattparks.mods.space.io.world.gen.dungeon.RoomTreasureIo;
...
public class ChunkProviderIo extends ChunkProviderGenerate {
	Block topBlockID = IoBlocks.ioBasicBlock;
	byte topBlockMeta = 0;
	Block fillBlockID = IoBlocks.ioBasicBlock;
	byte fillBlockMeta = 1;
	Block lowerBlockID = IoBlocks.ioBasicBlock;
	...
	private MapGenIoCave caveGenerator = new MapGenIoCave();

	private MapGenDungeon dungeonGenerator = new MapGenDungeon(IoBlocks.ioBasicBlock, 9, 8, 16, 6);
