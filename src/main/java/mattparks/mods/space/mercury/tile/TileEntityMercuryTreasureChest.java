package mattparks.mods.space.mercury.tile;

import java.util.Iterator;
import java.util.List;

import mattparks.mods.space.mercury.blocks.BlockT4MercuryTreasureChest;
...
public class TileEntityMercuryTreasureChest extends TileEntityAdvanced implements IInventory, IKeyable, IPacketReceiver
{
	 ...
	 */
	public TileEntityMercuryTreasureChest adjacentChestZNeg;

	/**
	 * Contains the chest tile located adjacent to this one (if any)
	 */
	public TileEntityMercuryTreasureChest adjacentChestXPos;

	/**
	 * Contains the chest tile located adjacent to this one (if any)
	 */
	public TileEntityMercuryTreasureChest adjacentChestXNeg;

	/**
	 * Contains the chest tile located adjacent to this one (if any)
	 */
	public TileEntityMercuryTreasureChest adjacentChestZPos;
	...
	public TileEntityMercuryTreasureChest(int tier)
	{
		this.tier = tier;
	}
	...
	private void func_90009_a(TileEntityMercuryTreasureChest par1TileEntityChest, int par2)
	{
	 ...
	 public void checkForAdjacentChests()
	{
		 if (!this.adjacentChestChecked)
		 {
			 ...
			 {
				 this.adjacentChestXNeg = (TileEntityMercuryTreasureChest) this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
			 }

			 if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
			 {
				 this.adjacentChestXPos = (TileEntityMercuryTreasureChest) this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
			 }

			 if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
			 {
				 this.adjacentChestZNeg = (TileEntityMercuryTreasureChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
			 }

			 if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
			 {
				 this.adjacentChestZPos = (TileEntityMercuryTreasureChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
			 }
	 ...
	 private boolean func_94044_a(int par1, int par2, int par3)
	 {
		 ...
		 return block != null && block instanceof BlockT4MercuryTreasureChest;
	 }
	 ...
	 {
		 if (this.getBlockType() != null && this.getBlockType() instanceof BlockT4MercuryTreasureChest)
		 {
			 --this.numUsingPlayers;
			 this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numUsingPlayers);
			 this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
