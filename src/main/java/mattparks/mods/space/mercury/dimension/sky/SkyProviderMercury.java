package mattparks.mods.space.mercury.dimension.sky;
...
{
	private static final ResourceLocation venusTexture = new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/venus.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMercury.venusTexture);
		tessellator1.startDrawingQuads();
