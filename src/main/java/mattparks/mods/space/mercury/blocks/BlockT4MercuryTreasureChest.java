...
public class BlockT4MercuryTreasureChest extends BlockContainer implements ITileEntityProvider
{
	private final Random random = new Random();

	public BlockT4MercuryTreasureChest(String assetName)
	{
		super(Material.rock);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("galacticraftmercury:mercuryTreasureChest");
	}
	...
	{
		return SpaceCore.proxy.getBlockRender(this);
	}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5)
	{
		...
		final TileEntityMercuryTreasureChest var6 = (TileEntityMercuryTreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	{
		final TileEntityMercuryTreasureChest var7 = (TileEntityMercuryTreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		else
		{
			if (par1World.getBlock(par2 - 1, par3, par4) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (TileEntityMercuryTreasureChest) par1World.getTileEntity(par2 - 1, par3, par4), (IInventory) var10);
			}

			if (par1World.getBlock(par2 + 1, par3, par4) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityMercuryTreasureChest) par1World.getTileEntity(par2 + 1, par3, par4));
			}

			if (par1World.getBlock(par2, par3, par4 - 1) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (TileEntityMercuryTreasureChest) par1World.getTileEntity(par2, par3, par4 - 1), (IInventory) var10);
			}

			if (par1World.getBlock(par2, par3, par4 + 1) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityMercuryTreasureChest) par1World.getTileEntity(par2, par3, par4 + 1));
			}
