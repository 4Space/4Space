...
{
	final Block topBlockID = MercuryBlocks.mercuryBasicBlock;
	final byte topBlockMeta = 0;
	final Block fillBlockID = MercuryBlocks.mercuryBasicBlock;
	final byte fillBlockMeta = 1;
	final Block lowerBlockID = MercuryBlocks.mercuryBasicBlock;
	...
	private final MapGenDungeon dungeonGenerator = new MapGenDungeon(MercuryBlocks.mercuryBasicBlock, 11, 8, 16, 3);
