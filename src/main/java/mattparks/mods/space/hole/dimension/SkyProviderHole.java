...
{
	private static final ResourceLocation sunTexture = new ResourceLocation(HoleCore.TEXTURE_PREFIX + "textures/gui/celestialbodies/wormhole.png");

	public int starList;
	public int glSkyList;
	public int glSkyList2;

	public SkyProviderHole(IGalacticraftWorldProvider provider)
	{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		// Render sun
		f10 = 19.0F;
		mc.renderEngine.bindTexture(SkyProviderHole.sunTexture);
