...
public class StructureComponentHoleVillageWoodHut extends StructureComponentHoleVillage
{
	private int averageGroundLevel = -1;

	public StructureComponentHoleVillageWoodHut()
	{
	}

	public StructureComponentHoleVillageWoodHut(StructureComponentHoleVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
	{
	...
	public static StructureComponentHoleVillageWoodHut func_74908_a(StructureComponentHoleVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
	{
		final StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 17, 9, 17, par6);
		return StructureComponent.findIntersecting(par1List, var8) == null ? new StructureComponentHoleVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
	}
