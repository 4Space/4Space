...
public class RoomChestsHole extends DungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;
    ...
    public RoomChestsHole(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new RoomChestsHole(dungeon, x, y, z, dir);
    }
