...
public class StructureComponentHoleVillageField2 extends StructureComponentHoleVillage {
	...
	public StructureComponentHoleVillageField2() {
	}

	public StructureComponentHoleVillageField2(StructureComponentHoleVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
	...
	public static StructureComponentHoleVillageField2 func_74900_a(StructureComponentHoleVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentHoleVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentHoleVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
	}
