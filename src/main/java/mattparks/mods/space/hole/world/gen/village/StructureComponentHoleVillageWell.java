...
public class StructureComponentHoleVillageWell extends StructureComponentHoleVillage {
	...
	public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random) {
		...
		StructureVillagePiecesHole.getNextStructureComponentVillagePath((StructureComponentHoleVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
	}
