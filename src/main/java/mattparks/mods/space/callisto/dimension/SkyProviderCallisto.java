...
public class SkyProviderCallisto extends IRenderHandler {
	...
	public SkyProviderCallisto(IGalacticraftWorldProvider asteroidsProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		WorldProviderCallisto gcProvider = null;

		if (world.provider instanceof WorldProviderCallisto) {
			gcProvider = (WorldProviderCallisto) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderCallisto.sunTexture);
		...
		world.getMoonPhase();
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, -800.0D, var12, 0, 1);
		var23.addVertexWithUV(var12, -800.0D, var12, 1, 1);
		var23.addVertexWithUV(var12, -800.0D, -var12, 1, 0);
		var23.addVertexWithUV(-var12, -800.0D, -var12, 0, 0);
		var23.draw();
