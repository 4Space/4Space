...
public class StructureComponentElipseVillageField2 extends StructureComponentElipseVillage {
	...
	public StructureComponentElipseVillageField2() {
	}

	public StructureComponentElipseVillageField2(StructureComponentElipseVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
	...
	public static StructureComponentElipseVillageField2 func_74900_a(StructureComponentElipseVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentElipseVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentElipseVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
	}
