...
public class StructureComponentElipseVillageWell extends StructureComponentElipseVillage {
	private int averageGroundLevel = -1;

	public StructureComponentElipseVillageWell() {
	}

	public StructureComponentElipseVillageWell(StructureComponentElipseVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5) {
	...
	public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random) {
		StructureVillagePiecesElipse.getNextStructureComponentVillagePath((StructureComponentElipseVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
		StructureVillagePiecesElipse.getNextStructureComponentVillagePath((StructureComponentElipseVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
		StructureVillagePiecesElipse.getNextStructureComponentVillagePath((StructureComponentElipseVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
		StructureVillagePiecesElipse.getNextStructureComponentVillagePath((StructureComponentElipseVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
	}
