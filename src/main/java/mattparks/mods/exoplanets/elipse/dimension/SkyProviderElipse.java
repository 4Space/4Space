...
public class SkyProviderElipse extends IRenderHandler {
	...
	public SkyProviderElipse(IGalacticraftWorldProvider provider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		tessellator1.startDrawingQuads();
		tessellator1.addVertexWithUV(-f10, -20.0D, f10, 0, 1);
		tessellator1.addVertexWithUV(f10, -20.0D, f10, 1, 1);
		tessellator1.addVertexWithUV(f10, -20.0D, -f10, 1, 0);
		tessellator1.addVertexWithUV(-f10, -20.0D, -f10, 0, 0);
		tessellator1.draw();
