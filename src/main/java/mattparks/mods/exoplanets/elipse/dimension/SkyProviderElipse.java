...
public class SkyProviderElipse extends IRenderHandler {
	private static final ResourceLocation sunTexture = new ResourceLocation(ExoCore.ASSET_PREFIX, "textures/gui/celestialbodies/star581.png");
	private static final ResourceLocation moonElpis_M1 = new ResourceLocation(ExoCore.ASSET_PREFIX, "textures/gui/celestialbodies/moons581.png");
	...
	public SkyProviderElipse(IGalacticraftWorldProvider asteroidsProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		WorldProviderElipse gcProvider = null;

		if (world.provider instanceof WorldProviderElipse) {
			gcProvider = (WorldProviderElipse) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderElipse.sunTexture);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, 175.0D, -var12, 0.0D, 0.0D);
		var23.addVertexWithUV(var12, 175.0D, -var12, 1.0D, 0.0D);
		var23.addVertexWithUV(var12, 175.0D, var12, 1.0D, 1.0D);
		var23.addVertexWithUV(-var12, 175.0D, var12, 0.0D, 1.0D);
		var23.draw();

		// Render Elipse M1
		var10 = 0.5F;
		GL11.glScalef(0.6F, 0.6F, 0.6F);
		GL11.glRotatef(360F, 1.0F, 0.0F, 1.0F);
		GL11.glRotatef(0F, 1.0F, 0.0F, 0.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderElipse.moonElpis_M1);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var10, -7.0D, var10, 0, 1);
		var23.addVertexWithUV(var10, -7.0D, var10, 1, 1);
		var23.addVertexWithUV(var10, -7.0D, -var10, 1, 0);
		var23.addVertexWithUV(-var10, -7.0D, -var10, 0, 0);
		var23.draw();
