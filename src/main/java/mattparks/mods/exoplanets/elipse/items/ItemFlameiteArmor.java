...
public class ItemFlameiteArmor extends ItemArmor {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer) {
		if (this.material == ElipseItems.ARMOR_FLAMEITE) {
			if (stack.getItem() == ElipseItems.flameiteHelmet) {
				return ElipseCore.TEXTURE_PREFIX + "textures/model/armor/flameite_1.png";
			} else if (stack.getItem() == ElipseItems.flameiteChestplate || stack.getItem() == ElipseItems.flameiteBoots) {
				return ElipseCore.TEXTURE_PREFIX + "textures/model/armor/flameite_2.png";
			} else if (stack.getItem() == ElipseItems.flameiteLeggings) {
				return ElipseCore.TEXTURE_PREFIX + "textures/model/armor/flameite_3.png";
			}
		}
		return null;
	}
