package mattparks.mods.space.io.network;
...
public class GCIoPacketHandlerServer implements IPacketHandler
{
	@Override
	public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player p)
	{
		...
		{
			FMLLog.severe("Galacticraft Io: Received bad packet!");
		}
