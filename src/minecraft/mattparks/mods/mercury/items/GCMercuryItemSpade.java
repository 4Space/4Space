package mattparks.mods.mercury.items;
...
public class GCMercuryItemSpade extends ItemSpade
{
    public GCMercuryItemSpade(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
