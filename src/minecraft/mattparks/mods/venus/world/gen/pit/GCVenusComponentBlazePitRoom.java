package mattparks.mods.venus.world.gen.pit;
...
public class GCVenusComponentBlazePitRoom extends GCCoreStructureComponent
{
    ...
    public GCVenusComponentBlazePitRoom(int type, World world, Random par2Random, int x, int y, int z, int height, int width, int cbm)
    {
        super(type);
