...
@Mod(name = GCIo.NAME, version = Version.LOCALMAJVERSION + "." + Version.LOCALMINVERSION + "." + Version.LOCALBUILDVERSION, useMetadata = true, modid = GCIo.MODID, dependencies = "required-after:" + GalacticraftCore.MODID + ";")
