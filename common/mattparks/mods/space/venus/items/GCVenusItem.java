...
{
    public static String[] names = { "sulfurDust", "ingotSulfur", "redGem", "ingotUranium", "venusCrystal", "sulfurPlate", "redGemPlate", "uraniumPlate", "plateHeavyT3", "venusRodDust", "venusPowerCrystal", 
	//"FossilizedPlant" 
	};
