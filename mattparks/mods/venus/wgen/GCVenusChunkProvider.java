...
import mattparks.mods.venus.wgen.dungeon.GCVenusRoomSpawner;
import mattparks.mods.venus.wgen.dungeon.GCVenusRoomTreasure;
import mattparks.mods.venus.wgen.pit.GCVenusMapGenBlazeNest;
import mattparks.mods.venus.wgen.village.GCVenusMapGenVillage;
...
public class GCVenusChunkProvider extends ChunkProviderGenerate
{
	...
	private final GCVenusCavern caveGenerator = new GCVenusCavern();
	private final GCVenusCaveGen caveGenerator2 = new GCVenusCaveGen();
	...
	{
		return GCVenusConfigManager.generateOtherMods ? "RandomLevelSource" : "MarsLevelSource";
	}
